...
const Sidebar = () => {
  ...
  const activeLink="flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-gray-700 text-md m-2"; // when dark mode implement change text-color of this class to text-white
