  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap justify-center lg:flex-nowrap'>
        <div className='w-full p-8 m-3 bg-white bg-center bg-no-repeat bg-cover bg-hero-pattern dark:text-gray-200 dark:bg-main-dark-bg h-44 rounded-xl lg:w-80 pt-9'>
          <div className='flex items-center justify-between'>
            <div>
                <p className='font-bold text-gray-400'>Earnings</p>
                <p className='text-2xl'>$49,869</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='flex flex-wrap items-center justify-center gap-1 m-3 text-center'>
